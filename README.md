...
I'm a recent graduate in Information Systems with a strong interest in data analytics, visualization, and user-centered design. I enjoy turning complex data into clear, actionable insights through interactive dashboards and thoughtful storytelling. With hands-on experience using tools like D3.js, Python, SQL, Excel, Tableau, and Power BI, I focus on making data approachable and useful for decision-makers. I'm currently seeking opportunities where I can contribute to data-driven projects and grow as a data analyst or business intelligence professional. Please scroll down to learn more about my projects!
...
|----------|----------|----------|----------|----------|
| [Click Me!](https://github.com/Lindy932/hr-churn-model-dashboard) | 📊 **Employee Turnover Risk & Retention Dashboard** | Google BigQuery, Google Colab, PyCaret, Looker Studio | Predicts employee turnover risk and provides HR with actionable insights to improve retention. Using 15k+ employee records from a pilot HR program, the dashboard identifies high-risk employees, highlights departments with elevated attrition, and ranks key drivers of turnover, helping HR teams implement targeted retention strategies. |  
| [Click Me!](https://github.com/Lindy932/ecommerce_dashboard) | 🛍️  **E-Commerce Sales & Operations Dashboard** | Power BI, Excel, PostgreSQL, DAX | Supports an e-commerce company's sales, logistics, and customer experience operations through data analysis and dashboarding. Using the Olist E-Commerce dataset, the Power BI dashboard answers key questions relevant to various departments: marketing, logistics, and customer success to help stakeholders identify bottlenecks, track KPIs, and improve customer retention. |  |
